...
function Peel(
  { children, id='default', options = {}, containerProps, ...props }: Props,
  refer: any
) {
  ...
  return (
    <div
      ref={ref}
      className={`${id}-peel ${props?.className}`}
      {...containerProps}
      style={{
...
const useInitializeCss = (id: string) => {
  useEffect(() => {
...
export const PeelTop = forwardRef(function (
  { id = "default", className = "", ...props }: HtmlDivProps,
  ref: React.Ref<HTMLDivElement>
) {
  return <div ref={ref} className={`${id}-peel-top ` + className} {...props}></div>;
});
...
export const PeelBack = forwardRef(function (
  ...
  return <div ref={ref} className={`${id}-peel-back ` + className} {...props}></div>;
});
...
export const PeelBottom = forwardRef(function (
  ...
  return (
    <div ref={ref} className={`${id}-peel-bottom ` + className} {...props}></div>
  );
});
